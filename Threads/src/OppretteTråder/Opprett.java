package OppretteTråder;

public class Opprett {
    ...
    public static void main(String[] args) throws InterruptedException {
		...
		// #1
		Thread t1 = new MinTraad();	// MinTraad er definert i egen java-fil

		// #2
		Thread t2 = new Thread() {	// Anonym klasse som extender Thread
			@Override
			public void run() {
		...
		// #3
		Thread t3 = new Thread(new MinRunnable()); // MinRunnable er definert i egen java-fil

		// #4
		Thread t4 = new Thread(new Runnable() { // Anonym klasse som implements Runnable
			@Override
			public void run() {
